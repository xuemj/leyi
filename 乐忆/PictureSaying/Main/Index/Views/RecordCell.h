...
@interface RecordCell : UITableViewCell<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate,ImagePickerViewControllerDelegateDefine>
...
@property(nonatomic, copy)NSString *haveEvent;
@end
