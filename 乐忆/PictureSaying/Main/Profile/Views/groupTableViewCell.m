...
-(void)_iniViews:(NSArray *)a{
    ...
    if (btn == nil)
    {
        ...
        [btn setImage:[UIImage imageNamed:@"addFriends.png"] forState:UIControlStateNormal];
...
-(void)tap:(UITapGestureRecognizer*)gesture
{
    ...
    if ([status isEqual:@0])
    {
        ...
        NSString *usn = [self.a[gesture.view.tag-100] objectForKey:@"friendUsn"];
        [dshareid setObject:pid forKey:@"userId"];
        [dshareid setObject:usn forKey:@"usn"];
